    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen w-screen">
        <div className="flex flex-col justify-center h-full w-full ">
          <h2 className="font-bold text-center text-slate-900 text-2xl lg:text-3xl">Welcome To dpr_coffee App</h2>
        ...
        <div className="hidden lg:flex lg:flex-col gap-4 h-full w-full bg-blue-600 justify-center items-center">
          ...
          <h1 className="text-3xl font-sans text-white font-medium">dpr_coffee</h1>
        </div>
      </div>
    </>
  );
